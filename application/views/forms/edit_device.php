...
<div class="container-fluid" style="padding:60px;"> <div class="row">
    ...
    <div class="col-md-4"><div class="well bs-component">
          <form class="form-horizontal" method="post" action = "<?php echo $base_url; ?>/device/edit_device/<?php echo $id; ?>">
            <fieldset>
              <legend style="color:#00ffff">New Device</legend>
              <div class="form-group is-empty">
                <label for="inputName" class="col-md-4 control-label">Device Name</label>

                <div class="col-md-8">
                  <input type="name" class="form-control" name="device_name" id="inputName" placeholder="Device Name" value ="<?php echo $device_name; ?>">
                </div>
              ...
              <div class="form-group is-empty">
                ...
                <div class="col-md-8">
                  <input type="name" class="form-control" name="device_id" id="inputEmail" placeholder="Device ID" value="<?php echo $device_id; ?>">
                </div>
                 <span class="material-input"></span></div>
             ...
             <!--  <span class="material-input"></span></div> -->
              <div class="form-group is-empty">
                ...
                <div class="col-md-8">
                  <textarea class="form-control" name="about_device" rows="3" id="textArea" placeholder="Discribe your device in short."><?php echo $about_device; ?></textarea>
